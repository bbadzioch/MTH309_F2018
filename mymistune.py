...
def preprocessing(text, tab=4):
    ...
    text = text.expandtabs(tab)             # replace tabs with 4 spaces
    text = text.replace('\u2424', '\n')     # '\u2424' is the unicode symbol of newline
    pattern = re.compile(r'^ +$', re.M)     # is a line consists of spaces only remove all spaces (but newline kept)
